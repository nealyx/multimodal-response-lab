...
class DatasetExporter:
    ...
    def export_json(
        ...
        doc = {
            ...
            "summary": {
                ...
                "mean_on_screen_fraction":     stats.mean_on_screen_fraction,
                "mean_blink_rate":             stats.mean_blink_rate,
                "missing_data": {
                    "no_samples":     stats.sessions_missing_samples,
                    "no_embeddings":  stats.sessions_missing_embeddings,
                    "no_labels":      stats.sessions_missing_labels,
                    "no_calibration": stats.sessions_missing_calibration,
                },
            },
    ...
    def export_csv(
        ...
        fields = [
            ...
            "mean_engagement_score", "on_screen_fraction", "mean_blink_rate",
        ...
        with open(p, "w", newline="", encoding="utf-8") as fh:
            ...
            for e in entries:
                ...
                writer.writerow({
                    ...
                    "on_screen_fraction":     round(e.on_screen_fraction,     4),
                    "mean_blink_rate":        round(e.mean_blink_rate,        2),
